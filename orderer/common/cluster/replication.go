...
var ErrSkipped = replication.ErrSkipped

// ErrForbidden denotes that an ordering node refuses sending blocks due to access control.
var ErrForbidden = replication.ErrForbidden

// ErrServiceUnavailable denotes that an ordering node is not servicing at the moment.
var ErrServiceUnavailable = replication.ErrServiceUnavailable

// ErrNotInChannel denotes that an ordering node is not in the channel
var ErrNotInChannel = replication.ErrNotInChannel

var ErrRetryCountExhausted = replication.ErrRetryCountExhausted
